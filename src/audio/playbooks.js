...
export const PLAYBOOKS = {
  hiphop: {
    ...
    // Slightly leaner lowMid — compression must not pile haze under the 808
    spectrum: spec({ sub: 0.11, bass: 0.33, lowMid: 0.14, mid: 0.23, high: 0.13, air: 0.06 }),
    checks: {
      maxSub: 0.18, minBass: 0.22, maxLowMid: 0.2, minPresence: 0.08,
      minCrest: 7, targetWidth: 0.14, vocalPresenceHz: 2800,
    },
    techniques: {
      rumbleHp: 28,
      // Keep 80–150 Hz solid for earbuds (AudioSpectra hip-hop tip)
      upperBassShelf: { f: 100, g: 0.7 },
      mudCut: { f: 280, g: -2.6, q: 0.85 },
      boxCut: { f: 450, g: -1.1, q: 1.0 },
      ...
      glue: { threshold: -21, ratio: 1.35, attack: 0.04, release: 0.24 },
      sat: 0.05,
      monoBassHz: 110,
      preserveWidth: true,
      protectLowEnd: true,
  ...
  pop: {
    ...
    spectrum: spec({ sub: 0.07, bass: 0.26, lowMid: 0.15, mid: 0.28, high: 0.16, air: 0.08 }),
    checks: {
      maxSub: 0.12, minBass: 0.2, maxLowMid: 0.2, minPresence: 0.1,
      minCrest: 7, targetWidth: 0.18, vocalPresenceHz: 2500,
    },
    techniques: {
      rumbleHp: 35,
      lowShelf: { f: 80, g: 0.35 },
      mudCut: { f: 300, g: -2.7, q: 0.9 },
      boxCut: { f: 480, g: -1.0, q: 1.0 },
      ...
      glue: { threshold: -19, ratio: 1.55, attack: 0.025, release: 0.18 },
      sat: 0.08,
      monoBassHz: 130,
      peakStyle: 'polish',
    },
  ...
  edm: {
    ...
    spectrum: spec({ sub: 0.12, bass: 0.35, lowMid: 0.11, mid: 0.21, high: 0.14, air: 0.07 }),
    checks: {
      maxSub: 0.22, minBass: 0.28, maxLowMid: 0.18, minPresence: 0.06,
      minCrest: 7.0, targetWidth: 0.24, vocalPresenceHz: 3000,
    },
    techniques: {
      rumbleHp: 28,
      lowShelf: { f: 65, g: 1.0 },
      mudCut: { f: 340, g: -2.2, q: 0.9 },
      boxCut: { f: 480, g: -1.3, q: 1.0 },
      ...
      deEss: { f: 8000, g: -0.6 },
      glue: { threshold: -22, ratio: 1.25, attack: 0.04, release: 0.2 },
      sat: 0.035,
  ...
  rock: {
    ...
    spectrum: spec({ sub: 0.06, bass: 0.24, lowMid: 0.16, mid: 0.31, high: 0.16, air: 0.07 }),
    checks: {
      maxSub: 0.1, minBass: 0.18, maxLowMid: 0.21, minPresence: 0.09,
      minCrest: 8, targetWidth: 0.16, vocalPresenceHz: 2200,
    },
    techniques: {
      rumbleHp: 35,
      mudCut: { f: 400, g: -2.7, q: 0.9 }, // classic rock congestion cut
      boxCut: { f: 520, g: -1.2, q: 1.0 },
      ...
      glue: { threshold: -21, ratio: 1.45, attack: 0.04, release: 0.25 },
      sat: 0.12,
      monoBassHz: 110,
      peakStyle: 'polish',
    },
  ...
  rnb: {
    ...
    spectrum: spec({ sub: 0.09, bass: 0.29, lowMid: 0.15, mid: 0.25, high: 0.14, air: 0.08 }),
    checks: {
      maxSub: 0.14, minBass: 0.22, maxLowMid: 0.2, minPresence: 0.09,
      minCrest: 7.5, targetWidth: 0.18, vocalPresenceHz: 2400,
    },
    techniques: {
      rumbleHp: 30,
      lowShelf: { f: 100, g: 0.55 },
      mudCut: { f: 280, g: -2.5, q: 0.9 },
      boxCut: { f: 440, g: -1.0, q: 1.0 },
      ...
      glue: { threshold: -21, ratio: 1.35, attack: 0.04, release: 0.26 },
      sat: 0.05,
      monoBassHz: 120,
      protectLowEnd: true,
      peakStyle: 'transparent',
  ...
  acoustic: {
    ...
    spectrum: spec({ sub: 0.05, bass: 0.22, lowMid: 0.18, mid: 0.29, high: 0.16, air: 0.1 }),
    checks: {
      maxSub: 0.09, minBass: 0.16, maxLowMid: 0.22, minPresence: 0.1,
      minCrest: 9, targetWidth: 0.14, vocalPresenceHz: 3000,
    },
    techniques: {
      rumbleHp: 40,
      mudCut: { f: 300, g: -2.0, q: 0.9 },
      boxCut: { f: 460, g: -0.8, q: 1.0 },
      vocalPresence: { f: 3000, g: 0.8, q: 1.0 },
      highShelf: { f: 12000, g: 0.8 },
      kickBassSep: { enabled: false },
      airSide: { f: 11000, g: 0.5 },
      glue: { threshold: -24, ratio: 1.25, attack: 0.05, release: 0.3 },
      sat: 0.035,
      monoBassHz: 100,
      peakStyle: 'open',
    },
  ...
  lofi: {
    ...
    // Warmth without compression mush — keep lowMid intentional but capped
    spectrum: spec({ sub: 0.09, bass: 0.3, lowMid: 0.2, mid: 0.25, high: 0.11, air: 0.05 }),
    checks: {
      maxSub: 0.14, minBass: 0.24, maxLowMid: 0.26, minPresence: 0.05,
      minCrest: 7, targetWidth: 0.1, vocalPresenceHz: 2000,
    },
    techniques: {
      rumbleHp: 30,
      lowShelf: { f: 120, g: 0.7 },
      mudCut: { f: 360, g: -1.8, q: 1.0 },
      boxCut: { f: 500, g: -0.9, q: 1.1 },
      highShelf: { f: 8000, g: -2.2 },
      vocalPresence: { f: 2000, g: 0.4, q: 1.0 },
      kickBassSep: { enabled: false },
      airSide: { f: 7000, g: -0.5 },
      glue: { threshold: -21, ratio: 1.35, attack: 0.045, release: 0.28 },
      sat: 0.12,
      monoBassHz: 130,
      protectLowEnd: true,
      peakStyle: 'transparent',
  ...
  latin: {
    ...
    spectrum: spec({ sub: 0.1, bass: 0.31, lowMid: 0.14, mid: 0.23, high: 0.14, air: 0.08 }),
    checks: {
      maxSub: 0.16, minBass: 0.24, maxLowMid: 0.18, minPresence: 0.09,
    ...
    techniques: {
      ...
      deEss: { f: 7500, g: -1.0 },
      glue: { threshold: -21, ratio: 1.28, attack: 0.035, release: 0.22 },
      sat: 0.035,
      monoBassHz: 110,
      preserveWidth: true,
      protectLowEnd: true,
  ...
  metal: {
    ...
    spectrum: spec({ sub: 0.07, bass: 0.26, lowMid: 0.15, mid: 0.31, high: 0.15, air: 0.06 }),
    checks: {
      maxSub: 0.11, minBass: 0.2, maxLowMid: 0.2, minPresence: 0.08,
      minCrest: 7, targetWidth: 0.14, vocalPresenceHz: 2500,
    },
    techniques: {
      rumbleHp: 35,
      mudCut: { f: 300, g: -2.8, q: 1.0 },
      boxCut: { f: 500, g: -1.3, q: 1.1 },
      ...
      glue: { threshold: -18, ratio: 1.65, attack: 0.02, release: 0.16 },
      sat: 0.1,
      monoBassHz: 110,
      peakStyle: 'firm',
    },
  ...
  jazz: {
    ...
    spectrum: spec({ sub: 0.06, bass: 0.24, lowMid: 0.18, mid: 0.29, high: 0.15, air: 0.08 }),
    checks: {
      maxSub: 0.1, minBass: 0.18, maxLowMid: 0.22, minPresence: 0.08,
      minCrest: 10, targetWidth: 0.16, vocalPresenceHz: 2500,
    },
    techniques: {
      rumbleHp: 30,
      mudCut: { f: 300, g: -1.5, q: 0.9 },
      boxCut: { f: 480, g: -0.7, q: 1.0 },
      highShelf: { f: 12000, g: 0.5 },
      vocalPresence: { f: 2500, g: 0.4, q: 1.0 },
      kickBassSep: { enabled: false },
      airSide: { f: 11000, g: 0.4 },
      glue: { threshold: -26, ratio: 1.2, attack: 0.05, release: 0.35 },
      sat: 0.04,
      monoBassHz: 90,
      peakStyle: 'open',
    },
  ...
  classical: {
    ...
    spectrum: spec({ sub: 0.06, bass: 0.22, lowMid: 0.18, mid: 0.29, high: 0.15, air: 0.1 }),
    checks: {
      maxSub: 0.1, minBass: 0.16, maxLowMid: 0.22, minPresence: 0.08,
      minCrest: 11, targetWidth: 0.14, vocalPresenceHz: 2000,
    },
    techniques: {
      rumbleHp: 24,
      mudCut: { f: 300, g: -1.2, q: 0.9 },
      boxCut: { f: 480, g: -0.55, q: 1.0 },
      highShelf: { f: 13000, g: 0.4 },
      kickBassSep: { enabled: false },
      airSide: { f: 12000, g: 0.3 },
      glue: { threshold: -28, ratio: 1.12, attack: 0.06, release: 0.4 },
      sat: 0.02,
      monoBassHz: 80,
      peakStyle: 'open',
    },
  ...
  podcast: {
    ...
    spectrum: spec({ sub: 0.03, bass: 0.12, lowMid: 0.16, mid: 0.36, high: 0.23, air: 0.1 }),
    checks: {
      maxSub: 0.06, minBass: 0.08, maxLowMid: 0.22, minPresence: 0.14,
      minCrest: 6, targetWidth: 0.08, vocalPresenceHz: 3000,
    },
    techniques: {
      rumbleHp: 80,
      mudCut: { f: 250, g: -2.8, q: 1.1 },
      boxCut: { f: 400, g: -1.2, q: 1.1 },
      vocalPresence: { f: 3000, g: 2.2, q: 1.0 },
      deEss: { f: 7000, g: -2.5 },
      highShelf: { f: 9000, g: 0.4 },
      kickBassSep: { enabled: false },
      airSide: { f: 8000, g: 0.2 },
      glue: { threshold: -20, ratio: 2.2, attack: 0.015, release: 0.15 },
      sat: 0.035,
      monoBassHz: 200,
      peakStyle: 'firm',
    },
